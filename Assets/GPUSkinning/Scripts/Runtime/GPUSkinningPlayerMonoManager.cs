...
public class GPUSkinningPlayerMonoManager
{
    ...
    public void Register(GPUSkinningAnimation anim, Mesh mesh, Material originalMtrl, TextAsset textureRawData, TextAsset textureBindRawData, GPUSkinningPlayerMono player, out GPUSkinningPlayerResources resources)
    {
        resources = null;

        if (anim == null || originalMtrl == null || textureRawData == null || player == null || textureBindRawData == null)
        {
            return;
        }
